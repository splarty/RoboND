...
class RoverState():
    def __init__(self):
        self.started = False # To record if the action has begun
        self.start_time = None # To record the start time of navigation
        self.total_time = None # To record total duration of naviagation
        self.stopped = None # To record if the Rover is stuck
        self.stopped_time = None # To record total duration of naviagation
        self.time_random_check = None # To check if circling
        self.current_position = None # To store the current positions
        self.curX = None # sample of current x positions
        self.curY = None # sample of current y positions
